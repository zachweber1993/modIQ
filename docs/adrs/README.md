...
| ADR-0010 | Engine Orchestration Simplification | Accepted (governance only; deletion of retired scaffolding not authorized — see ADR-0010 Status) |
| ADR-0011 | AssessmentReport Ownership Correction | Accepted (supersedes ADR-0003's `Assessment Report` example only — see ADR-0011 Status) |
