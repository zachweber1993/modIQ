...
An Assessment represents a complete analytical evaluation of a single Assessment Subject.
...
Assessment owns all runtime entities generated during its execution.

Supporting entities do not exist independently of an Assessment.
