...
- Remaining governed topic documents (`SettingsAndBilling.md`, `PlatformSurfaces.md`) have not yet been drafted and are unaffected by the freeze — new architectural work inherits this baseline rather than revisiting it.