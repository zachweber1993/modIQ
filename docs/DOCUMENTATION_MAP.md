...
| Platform Architecture | `docs/platform/` | The platform-level identity, tenancy, and containment model surrounding the Assessment. **Frozen as Platform Architecture 1.0** (constitutional foundation plus five governed topic documents: `IdentityAndAccess.md`, `ProjectsAndUploads.md`, `DashboardAndConsole.md`, `WayfindingAndSearch.md`, `Notifications.md`); all four Architectural Decisions Deferred resolved. `SettingsAndBilling.md`, drafted after the freeze, is Approved and unaffected by it. `PlatformSurfaces.md` was retired from the Governs list (2026-08-01) — no responsibility was ever assigned to it, and its only plausible reading is already fully governed elsewhere. No document remains undrafted. | `docs/platform/PlatformSpecification.md` |
...
- **`docs/platform/` has no `README.md` of its own yet**, unlike `docs/product-design/` and `docs/interaction-design/`. `PlatformSpecification.md` (constitutional) and its six governed topic documents (`IdentityAndAccess.md`, `ProjectsAndUploads.md`, `DashboardAndConsole.md`, `WayfindingAndSearch.md`, `Notifications.md`, `SettingsAndBilling.md`) are all synchronized; `PlatformSurfaces.md` was retired (2026-08-01) and no document remains undrafted. Not a defect — named here so a reader isn't surprised the directory still has no index of its own.
