...
| **Enabled Mods** | Exactly one mod, deliberately chosen or constructed to fail to load (e.g., a declared-version mismatch, a missing dependency, or a scripting fault a real Farming Simulator session actually surfaces) |
